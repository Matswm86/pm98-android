// FUN_005b41c0  entry=005b41c0  size=1618 bytes

undefined4 __fastcall FUN_005b41c0(int param_1)

{
  ...
  if (param_1 == *(int *)(*(int *)(param_1 + 400) + 0x40)) {
    ...
    if (iVar4 == 4) {
      ...
      local_4 = *(uint *)(param_1 + 0x224);
      iVar5 = *(int *)(param_1 + 0x1f0);
      if ((int)(((int)uVar3 < 1) - 1 & uVar3) <= (int)local_4) {
        local_4 = ((int)uVar3 < 1) - 1 & uVar3;
      }
      ...
      if ((iVar7 <= local_8) && (local_8 = iVar5, iVar5 < iVar8)) {
        local_8 = iVar8;
      }
      ...
      if ((iVar8 <= local_c) && (local_c = iVar5, iVar5 <= iVar4)) {
        local_c = iVar4;
      }
      FUN_005a89c0(&local_c,0x5a);
      return 1;
