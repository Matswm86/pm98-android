// FUN_005ae910  entry=005ae910  size=1157 bytes

void __fastcall FUN_005ae910(int param_1)

{
  ...
  if ((bVar3) && (*(int *)(param_1 + 0x7c) == *(int *)(*(int *)(param_1 + 400) + 0x80))) {
    ...
    if (cVar4 == '\0') {
      ...
      *(short *)(param_1 + 0x34) = *(short *)(param_1 + 0x34) + 0xb4;
      ...
      *(int *)(*(int *)(param_1 + 400) + 0x80) = *(int *)(*(int *)(param_1 + 400) + 0x80) + 1;
      ...
      iVar15 = CONCAT22((short)((uint)uVar12 >> 0x10),sVar5) + ((int)sVar8 << 1) / 3 +
               (iVar16 - iVar15);
      iVar16 = ((100 - *(int *)(param_1 + 0x388)) * 0x38e) / 100;
      if (iVar16 < 0x8000) {
        iVar14 = FUN_005ec250();
        iVar16 = (int)(iVar14 * iVar16 + (iVar14 * iVar16 >> 0x1f & 0x7fffU)) >> 0xf;
      }
      ...
      FUN_005ee6e0(iVar16 + 0x16c);
      FUN_005ee670(CONCAT22((short)((uint)iVar15 >> 0x10),(short)iVar15 + *(short *)(param_1 + 0x34)
                           ));
      iVar16 = *(int *)(param_1 + 400);
      *(int *)(iVar16 + 0x20) = iVar9 / 0x18 + ((int)(iVar10 + (iVar10 >> 0x1f & 0x1fU)) >> 5);
      *(undefined4 *)(iVar16 + 0x24) = 0;
      *(undefined4 *)(iVar16 + 0x28) = 0;
      iVar16 = *(int *)(param_1 + 400);
      *(int *)(iVar16 + 4) = *(int *)(iVar16 + 4) + *(int *)(param_1 + 0x20);
      *(int *)(iVar16 + 8) = *(int *)(iVar16 + 8) + *(int *)(param_1 + 0x24);
      *(int *)(iVar16 + 0xc) = *(int *)(iVar16 + 0xc) + *(int *)(param_1 + 0x28);
