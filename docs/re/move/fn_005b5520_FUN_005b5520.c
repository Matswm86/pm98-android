// FUN_005b5520  entry=005b5520  size=585 bytes

undefined4 __fastcall FUN_005b5520(int param_1)

{
  ...
  if (param_1 == *(int *)(iVar3 + 0x40)) {
    ...
    FUN_00590aa0(iVar3,0,0);
    puVar4 = (undefined4 *)FUN_00590ae0(local_18,param_1 + 4);
    ...
    piVar7 = (int *)FUN_005b3b20(local_18);
    local_24 = ((*(int *)(param_1 + 0x1ec) + *piVar7) / 2 + *(int *)(iVar3 + 4)) / 2;
    local_1c = ((piVar7[2] + *(int *)(param_1 + 500)) / 2 + *(int *)(iVar3 + 0xc)) / 2;
    local_20 = ((piVar7[1] + *(int *)(param_1 + 0x1f0)) / 2 + *(int *)(iVar3 + 8)) / 2;
    uVar8 = FUN_005b1330(local_c,param_1 + 0x210);
