// FUN_0047ca20  entry=0047ca20  size=484 bytes
// callers/callees expanded one level from seeds

bool __thiscall
FUN_0047ca20(int *param_1,int param_2,int param_3,undefined2 param_4,undefined2 param_5)

{
  ...
  *(undefined2 *)(param_1 + 2) = param_5;
  ...
  uVar5 = 0;
  pcVar4 = s_FIRST_DIVISION_00652e24;
