...
📦 **[Download the latest APK](https://github.com/Matswm86/pm98-android/releases/download/latest/pm98-b41be7e.apk)** — one tap downloads `pm98-b41be7e.apk` (current build) straight to your phone.
