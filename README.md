...
📦 **[Download the latest APK](https://github.com/Matswm86/pm98-android/releases/download/latest/pm98-bbddd0e.apk)** — one tap downloads `pm98-bbddd0e.apk` (current build) straight to your phone.
