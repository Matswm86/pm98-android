...
📦 **[Download the latest APK](https://github.com/Matswm86/pm98-android/releases/download/latest/pm98-8bda395.apk)** — one tap downloads `pm98-8bda395.apk` (current build) straight to your phone.
